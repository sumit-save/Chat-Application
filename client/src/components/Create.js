...
const Create = ({ socket }) => {
    ...
    useEffect(() => {
        const handleCreateRoomResponse = ({ id, name, room, message, status }) => {
            if (status === "FAILURE") {
        ...
        // Create Event Room Create Response
        socket.once("create-room-response", handleCreateRoomResponse);
        return () => {
            ...
            <div className="container d-flex justify-content-center align-items-center" style={{ height: "100vh" }}>
                <div className="border border-1 p-5">
                    <div className="text-center">
                        <h1 className="h3 display-3">CREATE</h1>
                    </div>
                    <div className="mt-3">
                    ...
                    <div className="mt-3 text-center">
                        <button type="button" className="btn btn-outline btn-outline-primary mx-1" onClick={handlerForCreate}>Create</button>
